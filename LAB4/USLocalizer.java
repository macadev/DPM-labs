...
public class USLocalizer {
	...
	public static double SENSOR_DISTANCE = 5.0; // Distance of the sensor from the robot's center
	...
	public void doLocalization() {
		...
		// double Error = 1.0;
		double threshold = 40; //TODO The threshold value when a robot sees the wall
